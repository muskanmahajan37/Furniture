...
<div class="register-hero">
    <div class="form-container">
        ...
        <form method="POST" class="form">
            <input class="my-input" type="name" name="name" id="name" placeholder="Full name"
                   data-validation="required">
            <br/>
            <input class="my-input" type="email" name="email" id="email" placeholder="Email" data-validation="email">
            <br/>
            <input class="my-input" type="password" name="password" id="password" placeholder="Password"
                   data-validation="required">
            <br/>
            <input class="my-input" type="password" name="confirmpassword" id="confirmpassword"
                   placeholder="Confirm Password" data-validation="required">
            <br/>
